...
""",
        ...
        # Clean up the assistant object from memory
        assistant = None
        gc.collect()
...
def upload_knowledge_file(client):
    ...
    try:
        # CRITICAL FIX: Use 'with' statement to ensure file is properly closed
        with open("knowledge.txt", "rb") as knowledge_file:
        ...
        # Clean up file object from memory
        file = None
        gc.collect()
